...
class SchedulingRepository implements ISchedulingRepository {
  ...
  async create({idClient, idProperty, idCompany, idEvaluation, titleProperty, imageProperty, nameClient, avatarClient, email, phone, whatsapp, type, status, meet,
    ...
    const scheduling: Scheduling = new Scheduling();
      ...
      Object.assign(scheduling, {
        id, _id: id, idClient, idProperty, idCompany, idEvaluation, titleProperty, imageProperty, nameClient, avatarClient, email, phone, whatsapp, type, status, meet,
  ...
  update({id, idClient, idProperty, idCompany, idEvaluation, titleProperty, imageProperty, email, phone, whatsapp, type, status, meet,
