...
class UpdateStatusUseCase {
  ...
  async execute({ id, type, verified, status, typeDocument, cpf_Cnpj, socialReason, fantasyName, creci, email, phone, whatsapp, textWhatsapp, whatsapp2, textWhatsapp2, whatsapp3, textWhatsapp3, whatsapp4, textWhatsapp4,  password,
    ...
    const passwordHash = await hash(await password, 8);
      ...
      await this.accountRepository.update({
        ...
        id, type, verified, status, typeDocument, cpf_Cnpj, socialReason, fantasyName, creci, email, phone, whatsapp, textWhatsapp, whatsapp2, textWhatsapp2, whatsapp3, textWhatsapp3, whatsapp4, textWhatsapp4,  password: passwordHash,
